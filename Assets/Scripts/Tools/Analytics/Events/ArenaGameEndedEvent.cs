...
namespace Analytics.Events
{
    ...
    {
        public ArenaGameEndedEvent(bool win, ECharacter character, int playerLevel, EArenaType arenaType, int currentLevel, int currentStage) : base(EGameMode.Arena, win, character, playerLevel) 
        {
